...
/** Render the shared mountain mark used by the 教务问答 wordmark and collapsed rail. */
function MountainMark({ size = 24, className }: { size?: number; className?: string | undefined }) {
  return (
    <svg
      width={(size * 40) / 32}
      height={size}
    ...
    >
      <path
        d="M2.5 27.5 13.8 10.2a1.7 1.7 0 0 1 2.8 0l7.7 11.2 4.2-6.4a1.7 1.7 0 0 1 2.8 0l6.2 12.5"
        stroke="currentColor"
        strokeWidth="2.4"
        strokeLinecap="round"
...
/** Render the compact 教务问答 brand for the expanded sidebar. */
function NwuWordmark() {
  return (
    <span className={css.nwuWordmark} aria-hidden="true">
      <MountainMark size={22} />
      <span>教务问答</span>
    </span>
  )
}
  ...
  return (
    ...
    >
      <div className={css.logoRow}>
        ...
        {/* Rail resting state is the mountain mark; hovering swaps in the panel
        ...
        <Tooltip label={collapsed ? t('toggle.open') : t('toggle.collapse')} delayMs={500}>
          ...
          >
            {!wide && <MountainMark className={css.railMountain} size={24} />}
