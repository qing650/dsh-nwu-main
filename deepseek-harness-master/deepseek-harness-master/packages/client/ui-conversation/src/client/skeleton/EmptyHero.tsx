// Hero chrome for the blank-draft phase of ConversationRoot: mountain headline,
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          <span className={css.mountainHitbox} aria-hidden="true">
            <svg width="34" height="32" viewBox="0 0 40 32" fill="none" focusable="false">
              <path
